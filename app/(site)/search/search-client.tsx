    ...
    <div className="space-y-10 pb-10 pt-10">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Try describing the job in simpler words — 'turn videos into shorts' works better than exact tool names — or clear your filters."
          primaryAction={{ label: "Clear filters", onClick: clearAll }}
          secondaryAction={{ label: "Browse categories", href: "/category" }}
        />
      )}
    </div>
  );
