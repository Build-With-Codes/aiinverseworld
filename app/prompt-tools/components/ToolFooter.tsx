...
export function ToolFooter() {
  return (
    <section className="rounded-card-lg border border-border-accent bg-gradient-to-r from-brand-electric/16 via-brand-violet/12 to-brand-cyan/16 p-7 shadow-glow-cyan lg:p-10">
